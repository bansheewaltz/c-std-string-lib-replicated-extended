...
START_TEST(strlen_1) {
  char *str_1 = "LUGANO\0";
  ck_assert_int_eq(strlen(str_1), x_strlen(str_1));
}
END_TEST

START_TEST(strlen_2) {
  char *str_2 = "LUGANO THE \0BEST!!!";
  ck_assert_int_eq(strlen(str_2), x_strlen(str_2));
}
END_TEST

START_TEST(strlen_3) {
  char *str_3 = "\0";
  ck_assert_int_eq(strlen(str_3), x_strlen(str_3));
}
END_TEST
...
START_TEST(strcat_1) {
  ...
  ck_assert_pstr_eq(strcat(b1, str_1_2), x_strcat(b11, str_1_2));
}
END_TEST
...
START_TEST(strcat_2) {
  ...
  ck_assert_pstr_eq(strcat(b2, str_2_2), x_strcat(b22, str_2_2));
}
END_TEST
...
START_TEST(strcat_3) {
  ...
  ck_assert_pstr_eq(strcat(b3, str_3_2), x_strcat(b33, str_3_2));
}
END_TEST
...
START_TEST(strcmp_1) {
  char *str_1_1 = "LUGANO!";
  char *str_1_2 = "LUGANO!";
  int x_c = x_strcmp(str_1_1, str_1_2);
...
START_TEST(strcmp_2) {
  ...
  int x_c = x_strcmp(str_2_1, str_2_2);
...
START_TEST(strcmp_3) {
  ...
  char *str_3_2 = "LUGANO!";
  int x_c = x_strcmp(str_3_1, str_3_2);
...
START_TEST(strncat_1) {
  ...
  char b11[1024] = "";
  char str_1_2[1024] = "LUGANO THE BEST!";
  ck_assert_pstr_eq(strncat(b1, str_1_2, n1), x_strncat(b11, str_1_2, n1));
}
END_TEST
...
START_TEST(strncat_2) {
  ...
  char b22[1024] = "THE";
  char str_2_2[1024] = " BEST!!";
  ck_assert_pstr_eq(strncat(b2, str_2_2, n2), x_strncat(b22, str_2_2, n2));
}
END_TEST
...
START_TEST(strncat_3) {
  ...
  char b33[1024] = "777";
  char str_3_2[1024] = " LUGANO!";
  ck_assert_pstr_eq(strncat(b3, str_3_2, n3), x_strncat(b33, str_3_2, n3));
}
END_TEST
...
START_TEST(strncmp_1) {
  ...
  char *str_1_1 = "LUGANO!";
  char *str_1_2 = "LUGANO!";
  int x_c = x_strncmp(str_1_1, str_1_2, n);
...
START_TEST(strncmp_2) {
  ...
  int x_c = x_strncmp(str_2_1, str_2_2, n);
...
START_TEST(strncmp_3) {
  ...
  char *str_3_1 = " LUGANO OF THE BEST!!";
  char *str_3_2 = "LUGANO!";
  int x_c = x_strncmp(str_3_1, str_3_2, n);
...
START_TEST(memset_1) {
  ...
  ck_assert_pstr_eq(memset(b1, c1, n1), x_memset(b11, c1, n1));
}
END_TEST
...
START_TEST(memset_2) {
  ...
  char b2[1024] = " BEST!!";
  char b22[1024] = " BEST!!";
  ck_assert_pstr_eq(memset(b2, c2, n2), x_memset(b22, c2, n2));
}
END_TEST
...
START_TEST(memset_3) {
  ...
  ck_assert_pstr_eq(memset(b3, c3, n3), x_memset(b33, c3, n3));
}
END_TEST
...
START_TEST(strcpy_1) {
  ...
  char b11[1024] = "";
  char str_1_2[1024] = "LUGANO THE BEST!";
  ck_assert_pstr_eq(strcpy(b1, str_1_2), x_strcpy(b11, str_1_2));
}
END_TEST
...
START_TEST(strcpy_2) {
  ...
  ck_assert_pstr_eq(strcpy(b2, str_2_2), x_strcpy(b22, str_2_2));
}
END_TEST
...
START_TEST(strcpy_3) {
  ...
  char b33[1024] = "777 ";
  char str_3_2[1024] = "LUGANO!";
  ck_assert_pstr_eq(strcpy(b3, str_3_2), x_strcpy(b33, str_3_2));
}
END_TEST
...
START_TEST(strncpy_1) {
  ...
  ck_assert_pstr_eq(strncpy(b1, str_1_2, n1), x_strncpy(b11, str_1_2, n1));
}
END_TEST
...
START_TEST(strncpy_2) {
  ...
  ck_assert_pstr_eq(strncpy(b2, str_2_2, n2), x_strncpy(b22, str_2_2, n2));
}
END_TEST
...
START_TEST(strncpy_3) {
  ...
  ck_assert_pstr_eq(strncpy(b3, str_3_2, n3), x_strncpy(b33, str_3_2, n3));
}
END_TEST
...
START_TEST(memcpy_1) {
  ...
  char b11[1024] = "";
  char str_1_2[1024] = "LUGANO THE BEST!";
  ck_assert_pstr_eq(memcpy(b1, str_1_2, n1), x_memcpy(b11, str_1_2, n1));
}
END_TEST
...
START_TEST(memcpy_2) {
  ...
  char b22[1024] = "";
  char str_2_2[1024] = "THE OF \0BEST!!";
  ck_assert_pstr_eq(memcpy(b2, str_2_2, n2), x_memcpy(b22, str_2_2, n2));
}
END_TEST
...
START_TEST(memcpy_3) {
  ...
  char b33[1024] = "777 ";
  char str_3_2[1024] = "LUGANO!";
  ck_assert_pstr_eq(memcpy(b3, str_3_2, n3), x_memcpy(b33, str_3_2, n3));
}
END_TEST
...
START_TEST(memcpy_4) {
  ...
  ck_assert_pstr_eq(memcpy(b4, b4 + 7, n4), x_memcpy(b44, b44 + 7, n4));
}
END_TEST
...
START_TEST(memmove_1) {
  ...
  char b1[1024] = "LUGANO THE BEST!";
  char b11[1024] = "LUGANO THE BEST!";
  ck_assert_pstr_eq(memmove(b1, b1 + 5, n1), x_memmove(b11, b1 + 5, n1));
}
END_TEST
...
START_TEST(memmove_2) {
  ...
  ck_assert_pstr_eq(memmove(b2, b2, n2), x_memmove(b22, b2, n2));
}
END_TEST
...
START_TEST(memmove_3) {
  ...
  ck_assert_pstr_eq(memmove(b3, b3, n3), x_memmove(b33, b33, n3));
}
END_TEST
...
START_TEST(memmove_4) {
  ...
  ck_assert_pstr_eq(memmove(b4, b4, n4), x_memmove(b44, b44, n4));
}
END_TEST

START_TEST(memchr_1) {
  char str[] = "Hello w\0orld\0";
  ck_assert_pstr_eq(memchr(str, 'r', 5), x_memchr(str, 'r', 5));
}
END_TEST

START_TEST(memchr_2) {
  char str2[] = "john.smith@microsoft.com";
  ck_assert_pstr_eq(memchr(str2, 's', 6), x_memchr(str2, 's', 6));
}
END_TEST

START_TEST(memchr_3) {
  char str3[] = {'q', 'r', 's', 't', 'w', '\0'};
  ck_assert_pstr_eq(memchr(str3, 's', 5), x_memchr(str3, 's', 5));
}
END_TEST

START_TEST(strchr_1) {
  char str[] = "Hello world";
  ck_assert_pstr_eq(strchr(str, ' '), x_strchr(str, ' '));
}
END_TEST

START_TEST(strchr_2) {
  char str2[] = "john.smith\0@microsoft.com";
  ck_assert_pstr_eq(strchr(str2, 'm'), x_strchr(str2, 'm'));
}
END_TEST

START_TEST(strchr_3) {
  char str3[] = "john.smith@microsoft.com";
  ck_assert_pstr_eq(strchr(str3, 'h'), x_strchr(str3, 'h'));
}
END_TEST

START_TEST(strrchr_1) {
  char str[] = "0163456769";
  ck_assert_pstr_eq(strrchr(str, '6'), x_strrchr(str, '6'));
}
END_TEST

START_TEST(strrchr_2) {
  char str2[] = "john.smith@microsoft.com";
  ck_assert_pstr_eq(strrchr(str2, 'o'), x_strrchr(str2, 'o'));
}
END_TEST

START_TEST(strrchr_3) {
  char str3[] = "john.smith@microsoft.com";
  ck_assert_pstr_eq(strrchr(str3, 'h'), x_strrchr(str3, 'h'));
}
END_TEST

START_TEST(strrchr_4) {
  char str4[] = "";
  ck_assert_pstr_eq(strrchr(str4, 'd'), x_strrchr(str4, 'd'));
}
END_TEST

START_TEST(strrchr_5) {
  char str5[] = {""};
  ck_assert_pstr_eq(strrchr(str5, 'z'), x_strrchr(str5, 'z'));
}
END_TEST

START_TEST(strcspn_1) {
  char str1[] = "this is a test";
  ck_assert_int_eq(strcspn(str1, "ab"), x_strcspn(str1, "ab"));
}
END_TEST
...
START_TEST(strcspn_2) {
  ...
  ck_assert_int_eq(strcspn(str2, "1234567890"),
                   x_strcspn(str2, "1234567890"));
}
END_TEST

START_TEST(strcspn_3) {
  char str3[] = {'q', 'r', 's', 't', 'w', 's', 'a', 's', '\0'};
  ck_assert_int_eq(strcspn(str3, "zx"), x_strcspn(str3, "zx"));
}
END_TEST

START_TEST(strspn_1) {
  char str[] = "12-years";
  ck_assert_int_eq(strspn(str, "1234567890"), x_strspn(str, "1234567890"));
}
END_TEST

START_TEST(strspn_2) {
  char str2[] = "this is a test";
  ck_assert_int_eq(strspn(str2, "shit "), x_strspn(str2, "shit "));
}
END_TEST

START_TEST(strspn_3) {
  char str3[] = {'q', 'r', 's', 't', 'w', 's', 'a', 's'};
  ck_assert_int_eq(strspn(str3, "01234"), x_strspn(str3, "01234"));
}
END_TEST

START_TEST(strpbrk_1) {
  char str[] = "this_is_a_";
  ck_assert_pstr_eq(strpbrk(str, "369"), x_strpbrk(str, "369"));
}
END_TEST

START_TEST(strpbrk_2) {
  char str2[] = "john.smith@mic\0rosoft.com";
  ck_assert_pstr_eq(strpbrk(str2, "fzx"), x_strpbrk(str2, "fzx"));
}
END_TEST

START_TEST(strpbrk_3) {
  char str3[] = {'q', 'r', 's', 't', 'w', 's', 'a', 's', '\0'};
  ck_assert_pstr_eq(strpbrk(str3, "saq"), x_strpbrk(str3, "saq"));
}
END_TEST

START_TEST(strstr_1) {
  char str[] = "";
  ck_assert_pstr_eq(strstr(str, ""), x_strstr(str, ""));
}
END_TEST

START_TEST(strstr_2) {
  char str2[] = "john.smith@mic\0rosoft.com";
  ck_assert_pstr_eq(strstr(str2, "sm"), x_strstr(str2, "sm"));
}
END_TEST

START_TEST(strstr_3) {
  char str3[] = {'q', 'r', 's', 't', 'w', 's', 'a', 's', '\0'};
  ck_assert_pstr_eq(strstr(str3, "woo"), x_strstr(str3, "woo"));
}
END_TEST

START_TEST(strerror_1) {
  int err_num = 7;
  ck_assert_pstr_eq(strerror(err_num), x_strerror(err_num));
}
END_TEST

START_TEST(strerror_2) {
  int err_num2 = 1;
  ck_assert_pstr_eq(strerror(err_num2), x_strerror(err_num2));
}
END_TEST

START_TEST(strerror_3) {
  int err_num3 = 404;
  ck_assert_pstr_eq(strerror(err_num3), x_strerror(err_num3));
}
END_TEST

START_TEST(strerror_4) {
  int err_num4 = 0;
  ck_assert_pstr_eq(strerror(err_num4), x_strerror(err_num4));
}
END_TEST
...
START_TEST(strtok_1) {
  ...
  nstr_2 = x_strtok(str4_2, del4);
  while (nstr_1 != x_NULL) {
    ck_assert_pstr_eq(nstr_1, nstr_2);
    nstr_1 = strtok(x_NULL, del4);
    nstr_2 = x_strtok(x_NULL, del4);
  }
}
END_TEST
...
START_TEST(to_upper_1) {
  ...
  char *str2 = (char *)x_to_upper(str1);
...
START_TEST(to_lower_1) {
  char str1[] = "hEllO, WoRLD!";
  char *str2 = (char *)x_to_lower(str1);
  ck_assert_pstr_eq(str2, "hello, world!");
  free(str2);
}
END_TEST
...
START_TEST(insert_1) {
  char *string = "diary";
  char *string2;
  string2 = x_insert(string, "ction", 2);
...
START_TEST(insert_2) {
  char *string = "diary";
  char *string2;
  string2 = x_insert(string, "ction", 8);
  ck_assert_pstr_eq(string2, x_NULL);
  free(string2);
}
END_TEST
...
START_TEST(trim_1) {
  char src1[] = "     &#@\n\n\t Hello, World! *&#@ \n\t   ";
  char trim_chars[] = " &#@\n\t";
  char *psrc = x_trim(src1, trim_chars);
...
START_TEST(strlen_empty) {
  char src[] = "";
  ck_assert_int_eq(x_strlen(src), strlen(src));
}
END_TEST
...
START_TEST(strncmp_empty) {
  ...
  char str2[] = "";
  x_size_t n_byte = 0;
  int got = x_strncmp(str1, str2, n_byte);
...
START_TEST(strrchr_empty) {
  char str1[] = "";
  char str2 = '\0';
  ck_assert_pstr_eq(x_strrchr(str1, str2), strrchr(str1, str2));
}
END_TEST
...
START_TEST(strpbrk_empty) {
  char str1[] = "";
  char str2[] = "";
  ck_assert_pstr_eq(x_strpbrk(str1, str2), strpbrk(str1, str2));
}
END_TEST
...
START_TEST(strspn_empty) {
  char src[] = "";
  char res[] = "";
  ck_assert_int_eq(x_strspn(res, src), strspn(res, src));
}
END_TEST
...
START_TEST(strstr_empty_string_haystack_and_needle) {
  char haystack[] = "";
  char needle[] = "";
  ck_assert_pstr_eq(x_strstr(haystack, needle), strstr(haystack, needle));
}
END_TEST
...
START_TEST(strtok_correct_token_string) {
  ...
  while (got && expected) {
    got = x_strtok(x_NULL, delims);
    expected = strtok(x_NULL, delims);
    if (got || expected) {
      ck_assert_str_eq(got, expected);
    } else {
...
START_TEST(strcspn_empty) {
  char src[] = "";
  char res[] = "";
  ck_assert_int_eq(x_strcspn(res, src), strcspn(res, src));
}
END_TEST
...
START_TEST(strchr_abobasnutsa_find_a) {
  ...
  char find = 'a';
  ck_assert_pstr_eq(x_strchr(src, find), strchr(src, find));
}
END_TEST
...
START_TEST(trim_test1) {
  ...
  char *got = (char *)x_trim(str, trim_ch);
  ck_assert_str_eq(got, expected);
  if (got) free(got);
}
END_TEST
...
START_TEST(memmove_empty_dest_and_src) {
  char src[200] = "";
  char src2[200] = "";
  x_size_t copy_kByte = 0;
  char *res = src;
  char *expected = src2;
  x_size_t check_kByte = 0;
  x_memmove(res, src, copy_kByte);
...
START_TEST(memmove_empty_dest) {
  ...
  x_size_t copy_kByte = 10;
  char res[200] = "";
  char expected[200] = "";
  x_size_t check_kByte = 10;
  x_memmove(res, src, copy_kByte);
  memmove(expected, src2, copy_kByte);
  ck_assert_mem_eq(res, expected, check_kByte);
}
...
START_TEST(memmove_write_in_left) {
  char src[200] = "Hate";
  char src2[200] = "Hate";
  x_size_t copy_kByte = 4;
  char res[200] = "i hate memcmp";
  char expected[200] = "i hate memcmp";
  x_size_t check_kByte = 17;
  x_memmove(res, src, copy_kByte);
  memmove(expected, src2, copy_kByte);
  ck_assert_mem_eq(res, expected, check_kByte);
}
...
START_TEST(memmove_write_in_right) {
  ...
  char expected[200] = "i hate memcmp";
  x_size_t check_kByte = 17;
  x_memmove(res + 13, src, copy_kByte);
...
START_TEST(memmove_write_in_mid) {
  ...
  char expected[200] = "i hate memcmp";
  x_size_t check_kByte = 17;
  x_memmove(res + 5, src, copy_kByte);
...
START_TEST(memmove_overlap_write_in_left) {
  ...
  x_size_t copy_kByte = 17;
  char *res = src;
  char *expected = src2;
  x_size_t check_kByte = 34;
  x_memmove(res, src, copy_kByte);
  memmove(expected, src2, copy_kByte);
  ck_assert_mem_eq(res, expected, check_kByte);
}
...
START_TEST(memcmp_zero_byte) {
  ...
  char str2[] = "aboba";
  int n = 0;
  ck_assert_int_eq(x_memcmp(str1, str2, n), memcmp(str1, str2, n));
}
END_TEST
...
START_TEST(memchr_empty_str) {
  ...
  char str[10] = "";
  int find_byte = '\0';
  ck_assert_ptr_eq(x_memchr(str, find_byte, n_byte),
...
START_TEST(memchr_find_num_in_array_num) {
  ...
  x_size_t n_byte = sizeof(int) * 7;
  int find_byte = 156;
  ck_assert_ptr_eq(x_memchr(array, find_byte, n_byte),
...
START_TEST(memchr_find_float_in_array) {
  ...
  x_size_t n_byte = sizeof(float) * 7;
  int find_byte = 666;
  ck_assert_ptr_eq(x_memchr(array, find_byte, n_byte),
                   memchr(array, find_byte, n_byte));
}
...
START_TEST(strntollu_test1) {
    char src[] = "-11";
    ck_assert_int_eq(x_strntollu(src, x_NULL, 19, 2), -20);
} END_TEST
// strntollu <-
*/
...
START_TEST(strtold_Doubles1) {
    ...
    a1 = x_strtold(str1);
    a2 = strtold(str1, x_NULL);

    b1 = x_strtold(str2);
    b2 = strtold(str2, x_NULL);

    c1 = x_strtold(str3);
    c2 = strtold(str3, x_NULL);

    d1 = x_strtold(str4);
    d2 = strtold(str4, x_NULL);
...
START_TEST(atoi_test1) {
    char src[] = "  +123123123";
    ck_assert_int_eq(atoi(src), x_atoi(src));
} END_TEST
*/
...
START_TEST(sprintf_simple_int) {
  ...
  int val = 69;
  ck_assert_int_eq(x_sprintf(str1, format, val), sprintf(str2, format, val));
...
START_TEST(sprintf_star_width_int) {
  ...
  char *format = "%0*d";
  int val = 69;
  ck_assert_int_eq(x_sprintf(str1, format, 5, val),
...
START_TEST(sprintf_many_flags_many_ints) {
  ...
  int val = 69;
  ck_assert_int_eq(
      x_sprintf(str1, format, 5, val, -10431, 13, 5311, 0, -581813581),
...
START_TEST(sprintf_unsigned_val_many) {
  ...
  unsigned long int val = 949149114140;
  ck_assert_int_eq(
      x_sprintf(str1, format, val, 14, 1441, 14414, 9681),
...
START_TEST(sprintf_octal_zero) {
  ...
  char *format = "%o";
  ck_assert_int_eq(x_sprintf(str1, format, 0), sprintf(str2, format, 0));
...
START_TEST(sprintf_unsigned_zero) {
  ...
  char *format = "%u";
  ck_assert_int_eq(x_sprintf(str1, format, 0),
...
START_TEST(sprintf_hex_many) {
  ...
  unsigned val = 858158158;
  ck_assert_int_eq(x_sprintf(str1, format, val, val, val, val, val, val),
...
START_TEST(sprintf_one_many) {
  ...
  char val = 'c';
  ck_assert_int_eq(x_sprintf(str1, format, val, 'c', 'a', 'b', 'b'),
...
START_TEST(sprintf_string_many) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, val, s1, s2, s3),
...
START_TEST(sprintf_ptr) {
  ...
  char *format = "%p";
  ck_assert_int_eq(x_sprintf(str1, format, format),
...
START_TEST(sprintf_null_ptr) {
  ...
  char *format = "%p";
  char *ptr = x_NULL;
  ck_assert_int_eq(x_sprintf(str1, format, ptr), sprintf(str2, format, ptr));
...
START_TEST(sprintf_n_specifier) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, &ret),
...
START_TEST(sprintf_float_many) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, val, val1, val2, val3, val4, val5),
...
START_TEST(sprintf_all_empty) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(x_sprintf(str1, "abc"), sprintf(str2, "abc"));
...
START_TEST(sprintf_test_one_char) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%c", '\t'), sprintf(str2, "%c", '\t'));
...
START_TEST(sprintf_test_many_char) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%c%c%c%c%c", '\t', '\n', '0', 'S', 's'),
...
START_TEST(sprintf_test_one_string) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%s", "Drop Sega PLS"),
...
START_TEST(sprintf_test_many_string) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%s%s%s%s%s", "Drop", " ", "Sega", " ", "PLS"),
...
START_TEST(sprintf_test_one_dec) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%d", 666), sprintf(str2, "%d", 666));
...
START_TEST(sprintf_test_many_dec) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%d%d%d%d", -999, 0, 666, -100),
...
START_TEST(sprintf_test_one_int) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%i", -0), sprintf(str2, "%i", -0));
...
START_TEST(sprintf_test_many_int) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%i%i%i%i", -999, 0, 666, -100),
...
START_TEST(sprintf_test_one_float) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(x_sprintf(str1, "%f", 0.0001),
...
START_TEST(sprintf_test_many_float) {
  ...
  char str2[BUFF_SIZE];
  ck_assert_int_eq(
      x_sprintf(str1, "%f%f%f%f", -999.666, 0.0001, 666.999, -100.001),
...
START_TEST(sprintf_test_one_unsigned_dec) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(x_sprintf(str1, "%u", 100),
...
START_TEST(sprintf_test_many_unsigned_dec) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%u%u%u%u", 999, 0, 666, 100),
...
START_TEST(sprintf_test_one_char_with_alignment_left) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%8c", '\t'), sprintf(str2, "%8c", '\t'));
...
START_TEST(sprintf_test_one_char_with_alignment_right) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%-8c", '\t'),
                   sprintf(str2, "%-8c", '\t'));
...
START_TEST(sprintf_test_many_char_with_alignment) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%3c%-11c%10c%-2c%c", '\t', '\n', '0', 'S', 's'),
...
START_TEST(sprintf_test_one_hex_lower) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  ck_assert_int_eq(x_sprintf(str1, "%x", (unsigned)INT32_MIN),
                   sprintf(str2, "%x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%x", 0), sprintf(str2, "%x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%x", INT32_MAX),
...
START_TEST(sprintf_test_many_hex_lower) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%x%x%x%x%x", 12340987, 135, 0, -1230, -123213123),
...
START_TEST(sprintf_test_one_hex_lower_with_alignment_left) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%-3x", (unsigned)INT32_MIN),
                   sprintf(str2, "%-3x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%-3x", 0), sprintf(str2, "%-3x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%-3x", INT32_MAX),
...
START_TEST(sprintf_test_one_hex_lower_with_alignment_right) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%13x", (unsigned)INT32_MIN),
                   sprintf(str2, "%13x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%13x", 0), sprintf(str2, "%13x", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%13x", INT32_MAX),
...
START_TEST(sprintf_test_one_hex_upper_with_alignment_left) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%-60X", INT32_MIN),
                   sprintf(str2, "%-60X", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%-60X", 0), sprintf(str2, "%-60X", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%-60X", INT32_MAX),
...
START_TEST(sprintf_test_one_hex_upper_with_alignment_right) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%7X", (unsigned)INT32_MIN),
                   sprintf(str2, "%7X", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%7X", 0), sprintf(str2, "%7X", 0));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%7X", INT32_MAX),
...
START_TEST(sprintf_test_many_hex_lower_with_alignment) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%2x%-7x%9x%11x%0x", 12340987, 100, 0, 1, -666999),
...
START_TEST(sprintf_test_one_hex_with_hashtag) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%#x", INT32_MIN),
                   sprintf(str2, "%#x", (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%#x", 0), sprintf(str2, "%#x", 0));
  ck_assert_str_eq(str1, str2);
...
START_TEST(sprintf_test_many_hex_lower_with_hashtag_and_alignm) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%#x%#x%3x%#32x%#-1x", 87, 1222224535, -13, -0,
                  123213123),
...
START_TEST(sprintf_test_one_hex_lower_with_width_star) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%*x", 11, INT32_MIN),
                   sprintf(str2, "%*x", 11, (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(x_sprintf(str1, "%*x", 11, 0),
                   sprintf(str2, "%*x", 11, 0));
  ck_assert_str_eq(str1, str2);

  ck_assert_int_eq(x_sprintf(str1, "%*x", 11, INT32_MAX),
...
START_TEST(sprintf_test_many_hex_lower_with_width_star_and_align_and_hashtag) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%#*x%*x%-12x%3x%*x", 9, 127312897, 0, -1,
                               199, -123978, 3, -1251),
...
START_TEST(sprintf_test_one_hex_upper_with_precision) {
  ...
  int a = x_sprintf(str1, "%*.6X", 11, INT32_MIN);
...
START_TEST(sprintf_test_many_hex_upper_with_precision_and_other) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, "%#3.*X%#3x%-7.*X%#-1.8X%4.3X%#2.15x%*.*X%*.1X%3X%-1X",
                  3, -126714, 4444444, 0, 6423235, 0, 666, 999, 13, 5, -419, 9,
                  41, -41, 33),
...
START_TEST(sprintf_test_one_hex_lower_with_length) {
  ...
  ck_assert_int_eq(x_sprintf(str1, "%hx", -11),
                   sprintf(str2, "%hx", (unsigned short)-11));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(x_sprintf(str1, "%hx", 0),
  ...
  ck_assert_int_eq(x_sprintf(str1, "%lx", val), sprintf(str2, "%lx", val));
  ck_assert_str_eq(str1, str2);
  long unsigned int v = 0;
  ck_assert_int_eq(x_sprintf(str1, "%lx", v), sprintf(str2, "%lx", v));
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_test_sprintf1) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 1), sprintf(str2, format, 1));
...
START_TEST(sprintf_test_sprintf2) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 1.1), sprintf(str2, format, 1.1));
...
START_TEST(sprintf_test_sprintf3) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 'a'), sprintf(str2, format, 'a'));
...
START_TEST(sprintf_test_sprintf4) {
  ...
  int val = 10000;
  int a = x_sprintf(str1, format, val);
...
START_TEST(sprintf_test_sprintf6) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 11.123456),
...
START_TEST(sprintf_test_sprintf7) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, "aboba floppa"),
...
START_TEST(sprintf_test_sprintf8) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 12341151),
...
START_TEST(sprintf_test_sprintf9) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 666666666666, 777, 111),
...
START_TEST(sprintf_test_sprintf10) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 666, -777, 111),
...
START_TEST(sprintf_test_sprintf11) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, -123, 321, -5555, -1213.123),
...
START_TEST(sprintf_test_sprintf12) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, format, 66666666666, 5555555555, 44444444444, k),
...
START_TEST(sprintf_test_sprintf14) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 1, 222, 33333333333, -166513.1232),
...
START_TEST(sprintf_test_sprintf17) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, "aboba likes floppa"),
...
START_TEST(sprintf_test_sprintf18) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, "", 'f'),
...
START_TEST(sprintf_test_sprintf19) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, "AHHAHAHA\0AHHAHAHAH"),
...
START_TEST(sprintf_test_sprintf20) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, "Nick her"),
...
START_TEST(sprintf_test_sprintf24) {
  ...
  ck_assert_int_eq(
      x_sprintf(str1, format, 'f', 21, 42, 666.666,
...
START_TEST(sprintf_test_sprintf25) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 121.123),
...
//   ck_assert_int_eq(x_sprintf(str1, format), sprintf(str2, format));
...
START_TEST(sprintf_test_sprintf28) {
  ...
  int n1;
  int n2;
  int a = x_sprintf(str1, "%d%n", 123, &n1);
...
START_TEST(sprintf_test_sprintf29) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 111.111),
...
START_TEST(sprintf_test_sprintf30) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 111), sprintf(str2, format, 111));
...
START_TEST(sprintf_test_sprintf31) {
  ...
  char format[] = "%e";
  double x = 111;
  ck_assert_int_eq(x_sprintf(str1, format, x), sprintf(str2, format, x));
...
START_TEST(sprintf_test_sprintf32) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 11.111, 222.2222, 666., -555.125),
...
START_TEST(sprintf_test_sprintf35) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 111.184314818),
...
START_TEST(sprintf_test_sprintf36) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 0.000111, 111.555, 1.999),
...
START_TEST(sprintf_test_sprintf37) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 0.666666),
...
START_TEST(sprintf_test_sprintf38) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 0.0000999, 111.9999, 6.666),
...
START_TEST(sprintf_test_sprintf39) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 123.123, a, b, c),
...
START_TEST(sprintf_test_sprintf40) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 123.111, 0.0000999, 0.555),
...
START_TEST(sprintf_test_sprintf43) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, 12345),
...
START_TEST(sprintf_test_sprintf44) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, hex), sprintf(str2, format, hex));
...
START_TEST(sprintf_g_many) {
  ...
  ck_assert_int_eq(x_sprintf(str1, format, hex, hex1, hex2, hex3, hex4, hex5),
...
START_TEST(sscanf_EOF1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, 0);
...
START_TEST(sscanf_EOF2) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1);
...
START_TEST(sscanf_only_chars1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1, &b1, &c1, &d1);
...
START_TEST(sscanf_special_symbols_as_chars3) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1, &b1, &c1);
...
START_TEST(sscanf_only_ints1) {
  ...
  int32_t res1 = x_sscanf(str, fstr, &a1, &b1, &c1, &d1);
...
START_TEST(sscanf_strings1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, s1, s2, s3, s4);
...
START_TEST(sscanf_strings_mixed3) {
  ...
  int16_t res1 = x_sscanf(str, fstr, s1, &a1, s2, &b1, s3, &c1, s4, &d1);
  int16_t res2 = x_sscanf(str, fstr, s5, &a2, s6, &b2, s7, &c2, s8, &d2);
...
START_TEST(sscanf_strings3) {
  ...
  int16_t res1 = x_sscanf(str, fstr);
...
START_TEST(sscanf_strings_mixed1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, s7, s9, &a1, s5, &b1, &c1, &d1, &e1, s1);
...
START_TEST(sscanf_strings_mixed2) {
  ...
  int16_t res1 = x_sscanf(str, fstr, s1, &a1, s2, s3, &b1, &v1, &d1);
...
START_TEST(sscanf_n1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1, &b1, &n1, &c1, &d1);
...
START_TEST(sscanf_n2) {
  ...
  int32_t res1 = x_sscanf(str, fstr, s1, s2, &n1, s3);
...
START_TEST(sscanf_n3) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &n1);
...
START_TEST(sscanf_uint3) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1, s1, &b1, &c1, &d1, &v1);
...
START_TEST(sscanf_upeer_hex_base_version) {
  ...
  const char str[] = "F";
  const char fstr[] = "%X";
  uint32_t res1 = x_sscanf(str, fstr, &a1);
...
START_TEST(sscanf_upeer_hex_short) {
  ...
  const char str[] = "F";
  const char fstr[] = "%hX";
  uint16_t res1 = x_sscanf(str, fstr, &a1);
...
START_TEST(sscanf_upeer_hex_star) {
  const char str[] = "0xFF0x0xFFF 0xFFxFF";
  const char fstr[] = "%*X";
  uint32_t res1 = x_sscanf(str, fstr);
...
START_TEST(sscanf_buff1) {
  ...
  int32_t res1 = x_sscanf(str, fstr, &a1, &b1);
...
START_TEST(sscanf_hard1) {
  ...
  int16_t res1 = x_sscanf(str, fstr, &a1, &a3, &n1);
...
START_TEST(sscanf_perc1) {
  ...
  int32_t res1 = x_sscanf(str, fstr, &a1, &b1, &c1);
...
START_TEST(sscanf_perc3) {
  ...
  const char str[] = "%%%16";
  const char fstr[] = "%%%%%%%d";
  int32_t res1 = x_sscanf(str, fstr, &a1);
...
START_TEST(sscanf_perc4) {
  const char str[] = "%%%";
  const char fstr[] = "%%%%%%";
  int32_t res1 = x_sscanf(str, fstr);
...
START_TEST(sscanf_hard3) {
  ...
  int32_t res1 = x_sscanf(str, fstr, &a1, b1, &c1, &d1, &e1);
...
Suite *suite_insert(void) {
  ...
  TCase *tc = tcase_create("additional_tests");
