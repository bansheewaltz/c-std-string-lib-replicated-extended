#ifndef INCLUDE_x_STRING_H_
#define INCLUDE_x_STRING_H_

#define x_size_t unsigned long long
...
int x_strncmp(const char *str1, const char *str2, x_size_t n);
char *x_strcpy(char *dest, const char *src);
char *x_strncpy(char *dest, const char *src, x_size_t n);
x_size_t x_strcspn(const char *str1, const char *str2);
...
void *x_to_lower(const char *str);
